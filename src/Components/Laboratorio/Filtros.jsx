...
export default function Filtros(props) {
  ...
  const cambiarFechaInicio = (event) => {
    props.set_fecha_inicio(event);
  };

  console.log(props.fecha_inicio)
  const cambiarFechaFin = (event) => {
    props.set_fecha_fin(event.target.value);
  };
  ...
  return (
    <Box sx={{ flexGrow: 1, mb: 6 }}>
          ...
          >
              <Grid item xs={2} container>
                <FormControl fullWidth>
                  ...
                  >
                    <MenuItem sx={{ width: 100, fontSize: 14 }} value={"TODOS"}>
                      TODOS
                    </MenuItem>
                    <MenuItem
      ...
      <DemoContainer components={['DatePicker', 'DatePicker']}>
        <DatePicker label="Uncontrolled picker" defaultValue={dayjs(props.fecha_inicio)} />
        <DatePicker
